  ...
  return <>
      ...
      <main className="pt-28 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className={`max-w-4xl mx-auto mb-12 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{
          transitionDelay: '200ms'
        }}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Order Pickup - First Position */}
              <div className={`bg-card p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 ${activeOption === 'pickup' ? 'scale-105 border-2 border-grill-gold' : 'hover:-translate-y-1'}`} onMouseEnter={() => handleOptionHover('pickup')} onMouseLeave={() => setActiveOption(null)}>
                <div className="h-32 flex items-center justify-center mb-6 relative">
                  <img src="/lovable-uploads/1769fc8b-f400-416e-ad38-c763a0dfa09a.png" alt="5 Star Direct" className={`h-24 object-contain transition-all duration-300 ${activeOption === 'pickup' ? 'scale-110' : ''}`} />
                </div>
                ...
                <Button asChild className="w-full bg-grill-gold hover:bg-grill-orange text-grill-black">
              ...
              <div className={`bg-card p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 ${activeOption === 'grubhub' ? 'scale-105 border-2 border-grill-gold' : 'hover:-translate-y-1'}`} onMouseEnter={() => handleOptionHover('grubhub')} onMouseLeave={() => setActiveOption(null)}>
                <div className="h-32 flex items-center justify-center mb-6">
                  <img src="/lovable-uploads/328cfcfd-602a-46f6-83d2-88419ec75beb.png" alt="GrubHub Logo" className={`h-24 object-contain transition-all duration-300 ${activeOption === 'grubhub' ? 'scale-110 pulse-glow' : ''}`} />
                </div>
              ...
              <div className={`bg-card p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 ${activeOption === 'doordash' ? 'scale-105 border-2 border-grill-gold' : 'hover:-translate-y-1'}`} onMouseEnter={() => handleOptionHover('doordash')} onMouseLeave={() => setActiveOption(null)}>
                <div className="h-32 flex items-center justify-center mb-6">
                  <img src="/lovable-uploads/3023517f-db29-4fe3-a755-849d2a497738.png" alt="DoorDash Logo" className={`h-24 object-contain transition-all duration-300 ${activeOption === 'doordash' ? 'scale-110 pulse-glow' : ''}`} />
                </div>
