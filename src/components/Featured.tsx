...
const Featured = () => {
  ...
  useEffect(() => {
    try {
      // Get menu items with static images from MenuImageLoader
      const itemsWithImages = MENU_ITEMS.map(item => {
        // Use the static image mapping from MenuImageLoader
      ...
      // Find lunch menu items with images - these will be our signature items
      const lunchItems = itemsWithImages.filter(item => item && item.category === 'lunch');
      
      // Select 3 signature items
      const selectedItems = lunchItems.slice(0, 3);
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-playfair">
            Our <span className="text-grill-gold">Signatures</span>
          </h2>
